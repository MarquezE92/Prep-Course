...
function esDiezOCinco(numero) {
  ...
  // Tu código:
  if (numero === 10 || numero === 5) {return true}; {return false};
}
...
function estaEnRango(numero) {
  ...
  // De lo contrario, devuelve "false"
  // Tu código:
  if (50 > numero && numero>20) {return true}; {return false};
}
...
function esEntero(numero) {
  ...
  // Tu código:
  if (numero=== Math.floor(numero)) {return true}; {return false};
}
...
function doWhile(numero) {
  ...
  let numero1= numero
  do {numero1 = numero1+5}
  while (numero1 < (numero+ 40)); return numero1;
}
